...
export const characterPositions: Record<SceneZoneId, CharacterPosition> = {
  ...
  gameDesk1: { left: 30, top: 32.9, zIndex: 24, scale: 1 },
  gameDesk2: { left: 52, top: 32.9, zIndex: 25, scale: 1 },
  gameDesk3: { left: 74, top: 32.9, zIndex: 26, scale: 1 },
  gameDesk4: { left: 40, top: 68.9, zIndex: 34, scale: 1 },
  gameDesk5: { left: 65, top: 68.9, zIndex: 35, scale: 1 },
};
