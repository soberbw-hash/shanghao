...
const providerPath: Record<MusicProviderId, string> = {
  spotify:
  ...
  applemusic:
    "M17.57 10.11v5.72c0 .42-.06.83-.24 1.21-.29.59-.76.96-1.39 1.14-.35.1-.71.16-1.07.17-.95.05-1.77-.6-1.94-1.54a1.88 1.88 0 0 1 1.04-2.02c.32-.16.67-.25 1.02-.33.38-.08.76-.15 1.13-.24.28-.06.46-.23.51-.51.02-.07.02-.13.02-.2V8.07c0-.06-.01-.12-.03-.18-.04-.15-.15-.25-.3-.24-.16.01-.32.04-.48.07L9.86 8.92c-.28.08-.38.2-.39.49v7.96c0 .42-.05.84-.22 1.23-.28.64-.77 1.04-1.43 1.23-.35.1-.71.16-1.08.17-.96.04-1.75-.6-1.92-1.54-.14-.81.23-1.69 1.15-2.08.36-.15.73-.23 1.11-.31.29-.06.58-.12.86-.18.38-.08.58-.32.6-.71V6.14c0-.12.01-.25.04-.37.07-.29.27-.45.55-.52l7.55-1.52c.31-.03.52.17.55.48.01.07.01.15.01.22v5.68z",
};
...
export const MusicActivityBadge = ({ activity }: { activity: MusicActivity }) => {
  ...
  return (
    ...
    >
      <span className="music-activity-icon" style={{ color: providerColor[activity.provider] }}>
