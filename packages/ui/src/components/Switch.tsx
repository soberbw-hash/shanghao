...
export const Switch = ({ isChecked, onChange }: SwitchProps) => (
  <button
    ...
    className={cn(
      "relative inline-flex h-7 w-12 items-center rounded-full border shadow-[inset_0_1px_1px_rgba(30,45,70,.08),0_2px_8px_rgba(63,102,160,.08)] backdrop-blur-xl transition-all duration-200",
      isChecked
