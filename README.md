...
> [!TIP]
> `main` 当前为 v2.9.2，包含房间场景、天气、好友响度匹配、录音清理与本地语音记忆，并修复屏幕分享放大模糊和 Windows 防火墙重复规则。完整变化见 [v2.9.2 更新公告](./docs/release-notes/v2.9.2.md)。
...
版本细节见 [CHANGELOG.md](./CHANGELOG.md)，普通用户说明见 [v2.9.2 更新公告](./docs/release-notes/v2.9.2.md)。
