...
> [!TIP]
> `main` 当前为 v2.9.0 源码，新增房间场景、天气、好友响度匹配、录音清理与本地语音记忆等能力。完整变化和当前验证边界见 [v2.9.0 更新公告](./docs/release-notes/v2.9.0.md)。
...
版本细节见 [CHANGELOG.md](./CHANGELOG.md)，普通用户说明见 [v2.9.0 更新公告](./docs/release-notes/v2.9.0.md)。
