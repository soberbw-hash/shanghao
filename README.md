...
> [!TIP]
> `main` 当前为 v3.0.3，新增正式账号基础、九套本地 ASR、统一 CUDA Runtime、1440p 屏幕分享与完整房间反馈，并集中修复模型下载、字级转录显示、录音库和开发账号连接。完整变化见 [v3.0.3 更新公告](./docs/release-notes/v3.0.3.md)。
...
版本细节见 [CHANGELOG.md](./CHANGELOG.md)，普通用户说明见 [v3.0.3 更新公告](./docs/release-notes/v3.0.3.md)。
