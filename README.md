...
> [!TIP]
> `main` 当前为 v2.9.1，包含房间场景、天气、好友响度匹配、录音清理与本地语音记忆，并修复 Windows 屏幕采集启动失败。完整变化见 [v2.9.1 更新公告](./docs/release-notes/v2.9.1.md)。
...
版本细节见 [CHANGELOG.md](./CHANGELOG.md)，普通用户说明见 [v2.9.1 更新公告](./docs/release-notes/v2.9.1.md)。
